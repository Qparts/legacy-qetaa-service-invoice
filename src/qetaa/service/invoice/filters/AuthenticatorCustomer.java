package qetaa.service.invoice.filters;
...
import qetaa.service.invoice.model.security.AccessMap;
...
public class AuthenticatorCustomer implements ContainerRequestFilter {
	...
	public void matchToken(String token, String username, String appSecret, String type, String authHeader) throws NotAuthorizedException{
		...
		if(type == "C"){
			...
			throw new NotAuthorizedException("Request authorization failed");// user not allowed to access this resource
		}
